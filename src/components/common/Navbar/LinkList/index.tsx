        ...
        <li key={key}>
          <Link href={value.link} passHref>
            <a
              ...
              className="fancy-ring fancy-ring-bg-secondary group flex flex-row items-center gap-2 rounded-sm decoration-primary-500 hover:underline hover:underline-offset-2 focus:underline"
            >

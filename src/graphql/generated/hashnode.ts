...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetAllBlogPosts(variables?: GetAllBlogPostsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetAllBlogPostsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAllBlogPostsQuery>(GetAllBlogPostsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAllBlogPosts', 'query');
    }
  };
}
